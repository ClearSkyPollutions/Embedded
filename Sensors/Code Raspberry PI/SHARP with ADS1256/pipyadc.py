...
class ADS1256(object):
    ...
    def pga_gain(self):
        ...
        """
        return 2**int.from_bytes(self.read_reg(REG_ADCON&0b111), byteorder = 'big')
    ...
    def ofc(self):
        ...
        """
        ofc0 = int.from_bytes(self.read_reg(REG_OFC0))
        ofc1 = int.from_bytes(self.read_reg(REG_OFC1))
        ofc2 = int.from_bytes(self.read_reg(REG_OFC2))
    ...
    def fsc(self):
        ...
        fsc0 = int.from_bytes(self.read_reg(REG_FSC0))
        fsc1 = int.from_bytes(self.read_reg(REG_FSC1))
        fsc2 = int.from_bytes(self.read_reg(REG_FSC2))
    ...
    def chip_ID(self):
        ...
        """
        self.wait_DRDY()
        return int.from_bytes(self.read_reg(REG_STATUS), byteorder = 'big') >> 4
    @chip_ID.setter
    ...
    def _send_byte(self, mybyte):
        ...
        wp.wiringPiSPIDataRW(self.SPI_CHANNEL, bytes([mybyte]))
    ...
    def read_async(self):
        ...
        byte_3 = int.from_bytes(self._read_byte())
        byte_2 = int.from_bytes(self._read_byte())
        byte_1 = int.from_bytes(self._read_byte())
    ...
    def read_and_next_is(self, diff_channel):
        ...
        # The result is 24 bits little endian two's complement value by default
        byte_3 = int.from_bytes(self._read_byte(), byteorder = 'big')
        byte_2 = int.from_bytes(self._read_byte(), byteorder = 'big')
        byte_1 = int.from_bytes(self._read_byte(), byteorder = 'big')
