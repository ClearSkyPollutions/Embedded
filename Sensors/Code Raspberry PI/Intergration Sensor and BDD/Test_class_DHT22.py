...
DHT22 = DHT22("capteur_multi_pollutions", "Sensor", "Sensor", "192.168.2.69", "8001", logger=log)

ave_read = 30
wait_a_wakeup = 30
wait_a_aver = 300 # -1 for no continue

setup_status = DHT22.setup(10)
...
if setup_status == "Connection failed":
    ...
    log.error("Sensor DHT22 wakeup failed")
    sys.exit(0)
elif setup_status == "KeyboardInterrupt":
    log.error("Keyboard Interrupt")


start_status = DHT22.start()
